...
WKHTMLTOPDF_PATH = "/usr/local/bin/wkhtmltopdf" # "C:\\Program Files\\wkhtmltopdf\\bin\\wkhtmltopdf.exe" # FOR MAC - "/usr/local/bin/wkhtmltopdf"    # FOR WINDOWS - "C:\\Program Files\\wkhtmltopdf\\bin\\wkhtmltopdf.exe"
